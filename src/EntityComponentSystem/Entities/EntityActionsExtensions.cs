...
public static class EntityActionsExtensions
{
    extension(IEntityActions actions)
    {
        ...
        /// </summary>
        public bool Has<T>(Identifier entity) => actions.ThrowIfNull().Has(entity, actions.GetEntityForType<T>());
        ...
        public T? Get<T>(Identifier entity) => actions.ThrowIfNull().Get<T>(entity, actions.GetEntityForType<T>());

        /// <summary>
        /// Returns a mutable reference of the component of type <typeparamref name="T"/> for the <paramref name="entity"/>.
        /// </summary>
        public ref T? GetMutable<T>(Identifier entity) => ref actions.ThrowIfNull().GetMutable<T>(entity, actions.GetEntityForType<T>());

        /// <summary>
        /// Adds the component of type <typeparamref name="T"/> to the <paramref name="entity"/>
        /// </summary>
        public void Add<T>(Identifier entity) => actions.ThrowIfNull().Add(entity, actions.GetEntityForType<T>());

        /// <summary>
        /// Sets the component's value for the <paramref name="entity"/> to the given <paramref name="value"/>
        /// </summary>
        public void Set<T>(Identifier entity, T value) => actions.ThrowIfNull().Set(entity, actions.GetEntityForType<T>(), value);

        /// <summary>
        /// Removes the component of type <typeparamref name="T"/> from the <paramref name="entity"/>
        /// </summary>
        public void Remove<T>(Identifier entity) => actions.ThrowIfNull().Remove(entity, actions.GetEntityForType<T>());
