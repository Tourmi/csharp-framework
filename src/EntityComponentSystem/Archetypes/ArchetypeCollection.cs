...
internal class ArchetypeCollection
{
    ...
    /// </summary>
    public void Create(Identifier id) => _entities[id.ShortId] = _emptyArchetype.AddEntity(id);
    ...
    /// </summary>
    public bool HasComponent(Identifier entityId, Identifier componentId) => _entities[entityId.ShortId].Archetype.HasComponent(componentId);

    /// <summary>
    /// Returns the value of the component.
    /// </summary>
    public T? GetComponent<T>(Identifier entityId, Identifier componentId) => _entities[entityId.ShortId].GetValue<T>(componentId);

    /// <summary>
    /// Returns a reference to the value of the component.
    /// </summary>
    public ref T? GetRefComponent<T>(Identifier entityId, Identifier componentId) => ref _entities[entityId.ShortId].GetValueRef<T>(componentId);

    /// <summary>
    /// Sets the value of the component.
    /// </summary>
    public void SetComponent<T>(Identifier entityId, Identifier componentId, T value) => _entities[entityId.ShortId].SetValue(componentId, value);
