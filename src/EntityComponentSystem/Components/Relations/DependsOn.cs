...
/// <summary>
/// <see cref="BuiltInRelationType.DependsOn"/>
/// </summary>
...
public readonly record struct DependsOn(
    DependsOn.DependencyMissingBehavior MissingBehavior = default,
    DependsOn.DependencyRemovedBehavior RemovedBehavior = default)
{
    /// <summary>
